...
class FetchController extends Controller {
    ...
    private function orderDonasiVerivikasi($decoded) {
        ...
        if (!is_null($this->model->getResult()->kontak)) {
            ...
            $text_pesan = 'Hi, *'. Sanitize::escape2($this->model->getResult()->nama) .'* donasimu telah kami terima, makasih ya kamu berpartisipasi di program *' . Sanitize::escape2($this->model->getResult()->nama_bantuan) . '*. Gunakan akun berbagi di https://pojokberbagi.id untuk melihat perkembangan dari donasimu atau scan QR yang ada di kuitansimu 🙆🏻‍♂️';
