...
class BannerModel extends HomeModel {
    ...
    public function getBanner() {
        $data = $this->db->query("WITH donasiDonaturInBanner AS (
            ...
            b.tag, b.nama nama_bantuan, b.jumlah_target, b.deskripsi, gm.path_gambar path_gambar_medium, IFNULL(gm.nama,CONCAT('Gambar ',b.nama)) nama_gambar_medium, gw.path_gambar path_gambar_wide, IFNULL(gw.nama,CONCAT('Gambar ',b.nama)) nama_gambar_wide, k.nama nama_kategori,
